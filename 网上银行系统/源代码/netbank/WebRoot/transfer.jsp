...
<html>
  ...
  <body>
	<body onload="disptime()">
		<form action="/netbank/transaction/transfer" method="post" onsubmit="return deposit()">
			<div align="center" style="margin-top:20px">
				<table width="400" border="0" class="table">
					<tbody>
						<tr>
							<td width="100">&nbsp;转账时间：</td>
							<td><input type="text" name="log.datetime" id="datetime" value="${log.datetime}"/></td>
						</tr>
						<tr>
							<td width="100">&nbsp;对方账户：</td>
							<td><input type="text" name="log.otherid" id="otherid" value="${log.otherid}"/>
