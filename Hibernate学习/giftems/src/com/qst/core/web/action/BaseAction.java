package com.qst.core.web.action;
...
import com.qst.core.exception.BaseAppRuntimeException;
...
public abstract class BaseAction extends ActionSupport {
     ...
     * 把成功或失败信息保存到Session中
     */
    protected void saveMessage(String code, String[] args) {
     ...
     * 把成功或失败信息保存到Session中
     */
    protected void saveMessage(String code, String[] args, String defaultMessage) {
    ...
    protected String getMessage(String code, String[] args,
    	...
    	return this.getText(code,defaultMessage,args);
    }
    ...
    public void validateExecute() {
        ...
        try {
            ...
            // 获取首字母大写的方法名
            capitalizedMethodName = capitalizeMethodName(methodName);
            // 构造验证方法名
            prefixedMethodName = VALIDATE_PREFIX + capitalizedMethodName;
            ...
            if (StringUtils.isEmpty(prefixedMethodName)) {
                logger.debug(prefixedMethodName + " method is empty");
            } else {
